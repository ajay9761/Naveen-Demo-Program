...
public class JavaScriptExecutorConcept {
	...
	public static void main(String[] args) throws Exception {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Drivers\\chromedriver.exe");	
				...
				FileUtils.copyFile(src, new File("D:\\NewEclips\\workspace\\DemoProgram\\element.png"));
		    ...
		    public static void clickElementByJS(WebElement element, WebDriver driver) throws Exception{
		    	JavascriptExecutor js = ((JavascriptExecutor) driver);
		    	js.executeScript("arguments[0].click();", element);
		    	 Thread.sleep(1000);
		    }
			
		    public static void refreshBrowserByJS(WebDriver driver) throws Exception{
		    	JavascriptExecutor js = ((JavascriptExecutor) driver);
		    	js.executeScript("history.go(0)");
		    	 Thread.sleep(1000);
		    }
		    
		    public static String getTitleByJS(WebDriver driver) throws Exception{
		    	JavascriptExecutor js = ((JavascriptExecutor) driver);
		    ...
		    public static String getPageInnerText(WebDriver driver) throws Exception{
		    	JavascriptExecutor js = ((JavascriptExecutor) driver);
		    ...
		    public static void scrollIntoView(WebElement element, WebDriver driver) throws Exception{
		    	JavascriptExecutor js = ((JavascriptExecutor) driver);
